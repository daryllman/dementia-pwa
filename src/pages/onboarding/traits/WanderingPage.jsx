...
function WanderingPage({goBack, handleSave}){
    return (
        <>
        <BackButton onClick={goBack}/>
        <HeaderTitle>Wandering</HeaderTitle>
        <DarkGreenContainer>
            {/*_______________________________________________________ */}
            <QuestionTitle>Tendency to wander around, and not knowing the way</QuestionTitle>
            <GradingForm type="single" options={gradingOptions}/>
            <DividerLine/>
            {/*_______________________________________________________ */}
            <QuestionTitle>Likes to exit a room/ building</QuestionTitle>
            <GradingForm type="single" options={gradingOptions}/>
            <DividerLine/>
            {/*_______________________________________________________ */}
            <QuestionTitle>Forgets their location</QuestionTitle>
            <GradingForm type="single" options={gradingOptions}/>
            <DividerLine/>
            {/*_______________________________________________________ */}
